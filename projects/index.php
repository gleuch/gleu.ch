  ...
  <div id="content_area" class="rel c">
   ...
   <article id="content">
    ...
    <aside class="footer tc">
     <p class="large link a b"><a href="/projects/all" class="b">View list of all projects &raquo;</a></p>
    </aside>
   ...
   <aside id="sidebar">
    <section class="box">
     ...
     <p>His projects are primarily released through the <a href="http://fffff.at" target="_blank">Free Art &amp; Technology Lab (F.A.T. Lab)</a> and <a href="http://www.xolator.com" target="_blank">XOlator</a>.</p>
    </section>
